...
export type ReportTId = string;
export type ReportRespose = CustomResponse<Recipe>;

export class RecipeController implements RecipeService<ReportRespose> {
  ...
  async getAllRecipesList(req: Request, res: Response): Promise<CustomResponse<ReportRespose>> {
